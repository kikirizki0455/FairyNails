...
<body>
    ...
    <div class="container">
        ...
        <!-- Konten Email -->
        <div class="content">
            <h2>Halo {{ $pendingUser->name }},</h2>
            <p>Terima kasih telah bergabung dengan <strong>Fairy Nails</strong>!</p>
            <p>Kami sangat senang menyambut Anda. Dengan akun baru Anda, Anda bisa menikmati layanan terbaik kami.</p>
            <p>Akun Anda sedang menunggu validasi admin. <br>Anda akan menerima notifikasi lebih lanjut setelah akun
                Anda disetujui.</p>
            <p>Jika Anda tidak mendaftar, Anda dapat mengabaikan email ini.</p>
        </div>
